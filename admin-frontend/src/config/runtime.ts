...
function readUrl(
  environment: RuntimeEnvironment,
  name: 'VITE_REST_API_URL' | 'VITE_USER_APP_URL',
...
export function parseRuntimeConfig(
  ...
  return {
    region: readMatchingString(environment, 'VITE_AWS_REGION', REGION_PATTERN),
    ...
    restApiUrl: readUrl(environment, 'VITE_REST_API_URL', 'https:'),
    restApiKey: readMatchingString(
      environment,
      'VITE_REST_API_KEY',
      PRINTABLE_ASCII_PATTERN,
    ),
    userAppUrl: readUrl(environment, 'VITE_USER_APP_URL', 'https:'),
  };
}
